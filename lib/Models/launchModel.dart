...
//
//     final launchModel = launchModelFromJson(jsonString);

import 'dart:convert';

LaunchModel launchModelFromJson(String str) =>
    LaunchModel.fromJson(json.decode(str));

String launchModelToJson(LaunchModel data) => json.encode(data.toJson());
